...
public abstract class Message implements Serializable {
   ...
   */
  enum Key {
    CLIENT_PUB_RSA, DATASET, MAX_MAF, MAX_MAF_NFE, LIMIT_TO_SNVS, MIN_CSQ, DATASETS, TPS_NAME, ENCRYPTED_AES, ENCRYPTED_CLIENT_DATA, ENCRYPTED_CLIENT_EXCLUDED_VARIANT, ALGORITHM, ERROR_MESSAGE, ENCRYPTED_RESULTS, ENCRYPTED_HASH, THIRD_PUB_RSA, STATUS, SESSION, BED_FILE, EXCLUDED_VARIANTS
  }
