...
public class LineBuilder {
  ...
  public LineBuilder openHTML(String tag, String clazz) {
    return openHTML(tag, clazz, new String[][]{});
  }
  ...
  public LineBuilder openHTML(String tag, String clazz, String[]... extra) {
    this.append("<").append(tag);
    if (clazz != null)
      this.addSpace("class=\"").append(clazz).append("\"");
  ...
  public LineBuilder openCloseHTML(String tag, String clazz) {
    return openCloseHTML(tag, clazz, new String[][]{});
  }
  ...
  public LineBuilder openCloseHTML(String tag, String clazz, String[]... extra) {
    this.append("<").append(tag);
    if (clazz != null)
      this.addSpace("class=\"").append(clazz).append("\"");
    if (extra != null)
  ...
  public LineBuilder rstTitle(String title, char underline) {
    String line = replaceAll(title, underline);
  ...
  public LineBuilder rstGridTable(String[][] table, boolean hasHeader) {
    ...
    ArrayList<String>[][] multiLines = getMultiLines(table);
    ...
    for (int col = 0; col < multiLines[0].length; col++) {
      del.append("-");
      del.append(replaceAll(multiLines[0][col].get(0), '-'));
      del.append("-");
      del.append("+");
    }
  ...
  /**
   * Transform a table au Strings, into a table of ArrayList:String, by splitting line-breaks
   * @param table the table to expend
   * @return the expended table
   */
  public static ArrayList<String>[][] getMultiLines(String[][] table) {
  ...
  public static ArrayList<String>[][] trimAndPad(ArrayList<String>[][] table) {
    int rows = table.length;
    int cols = table[0].length;
    ArrayList<String>[][] ret = new ArrayList[rows][cols];
    //get the length of the longest line in any cell)
    int[] width = new int[cols];
    for (int row = 0; row < rows; row++)
      for (int col = 0; col < cols; col++)
        for (String line : table[row][col])
          width[col] = Math.max(width[col], line.trim().length());
    ...
    for (int row = 0; row < rows; row++)
      for (int col = 0; col < cols; col++) {
        ...
        for (String line : table[row][col])
          ret[row][col].add(pad(line.trim(), width[col]));
      }
  ...
  public static String replaceAll(String origin, char replacement) {
  ...
  public LineBuilder append(boolean b) {
  ...
  public LineBuilder append(char[] str) {
    stringBuilder.append(str);
    return this;
  }

  public LineBuilder append(char[] str, int offset, int len) {
    stringBuilder.append(str, offset, len);
    return this;
  }

  public LineBuilder append(CharSequence s) {
    stringBuilder.append(s);
    return this;
  }

  public LineBuilder append(CharSequence s, int start, int end) {
  ...
  public LineBuilder append(long lng) {
  ...
  public LineBuilder append(StringBuffer sb) {
    stringBuilder.append(sb);
    return this;
  }

  public LineBuilder append(LineBuilder lb) {
    stringBuilder.append(lb.stringBuilder);
    return this;
  }

  public LineBuilder appendCodePoint(int codePoint) {
  ...
  public LineBuilder insert(int offset, boolean b) {
    stringBuilder.insert(offset, b);
    return this;
  }

  public LineBuilder insert(int offset, char c) {
    stringBuilder.insert(offset, c);
    return this;
  }

  public LineBuilder insert(int offset, char[] str) {
    stringBuilder.insert(offset, str);
    return this;
  }

  public LineBuilder insert(int index, char[] str, int offset, int len) {
    stringBuilder.insert(index, str, offset, len);
    return this;
  }

  public LineBuilder insert(int dstOffset, CharSequence s) {
    stringBuilder.insert(dstOffset, s);
    return this;
  }

  public LineBuilder insert(int dstOffset, CharSequence s, int start, int end) {
    stringBuilder.insert(dstOffset, s, start, end);
    return this;
  }

  public LineBuilder insert(int offset, double d) {
    stringBuilder.insert(offset, d);
    return this;
  }

  public LineBuilder insert(int offset, float f) {
    stringBuilder.insert(offset, f);
    return this;
  }

  public LineBuilder insert(int offset, int i) {
    stringBuilder.insert(offset, i);
    return this;
  }

  public LineBuilder insert(int offset, long l) {
    stringBuilder.insert(offset, l);
    return this;
  }

  public LineBuilder insert(int offset, Object obj) {
    stringBuilder.insert(offset, obj);
    return this;
  }

  public LineBuilder insert(int offset, String str) {
    stringBuilder.insert(offset, str);
    return this;
  }
  ...
  public LineBuilder replace(int start, int end, String str) {
